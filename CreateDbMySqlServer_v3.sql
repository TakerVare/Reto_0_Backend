...
-- MySQL Server
-- (Corregido: Todos los IDs de entidad son VARCHAR(50))
-- =============================================
...
-- (MODIFICADO: FeatureId es VARCHAR(50) para referenciar Features.Id)
...
-- (MODIFICADO: LayerId y ParameterId son VARCHAR(50))
...
-- Insertar Categorías (Sin cambios)
...
-- Insertar EventCategories (Sin cambios)
...
-- Insertar EventGeometries (Corregido en la versión anterior)
...
-- Insertar Properties (Sin cambios)
...
-- Insertar PropertyCategories (Sin cambios)
INSERT INTO PropertyCategories (PropertyId, CategoryId) VALUES
('EONET_15547', 'severeStorms'),
('EONET_15545', 'severeStorms'),
('EONET_15546', 'severeStorms');

-- Insertar PropertySources (Sin cambios)
...
-- Insertar Features
-- (MODIFICADO: Se añade el Id VARCHAR(50) manual)
...
-- (MODIFICADO: Se usan los IDs 'F1', 'F2', 'F3' en lugar de 1, 2, 3)
...
-- (MODIFICADO: Se usan los IDs 'L1'-'L7' y '2km_png' en lugar de 1-7 y 1)
